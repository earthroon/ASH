...
cargo build -p base_train --bin ash_basetrain_gpu_13_chunk_window_logits_value_stability_audit --jobs 1
cargo run --jobs 1 -p base_train --bin ash_basetrain_gpu_13_chunk_window_logits_value_stability_audit
