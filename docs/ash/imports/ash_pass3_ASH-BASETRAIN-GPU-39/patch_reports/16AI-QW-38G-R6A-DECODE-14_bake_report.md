# 16AI-QW-38G-R6A-DECODE-14 Bake Report

- base_zip: ash_pass3_16AI-QW-38G-R6A-DECODE-13_span_error_receipt_translation_error_region_seal_baked.zip
- output_zip: ash_pass3_16AI-QW-38G-R6A-DECODE-14_source_adequacy_guard_enko_meaning_preservation_seal_baked.zip
- status: PASS_STATIC_SOURCE_ADEQUACY_GUARD_CONTRACT
- domain_ssot: en_to_ko_translation_subtitle_machine

## Added Rust modules
- crates/ash_core/src/source_adequacy_policy.rs
- crates/ash_core/src/source_adequacy_risk.rs
- crates/ash_core/src/source_adequacy_guard.rs
- crates/ash_core/src/source_adequacy_receipt.rs
- crates/ash_core/src/source_adequacy_stub.rs
...
## Contract boundary
DECODE-14 converts DECODE-13 span error packets into deterministic source adequacy decisions. It may recommend review, reject, rewrite, or glossary gate, but it does not execute candidate rejection, fallback apply, rewrite, rollback, model forward, sampling, QE model, external adequacy model, or glossary constraints.
...
```json
{
  ...
  "patch_id": "16AI-QW-38G-R6A-DECODE-14",
