# 16AI-QW-38G-R6A-DECODE-13 Bake Report

- base_zip: ash_pass3_16AI-QW-38G-R6A-DECODE-12_reference_free_qe_adapter_stub_source_candidate_quality_slot_seal_baked.zip
- output_zip: ash_pass3_16AI-QW-38G-R6A-DECODE-13_span_error_receipt_translation_error_region_seal_baked.zip
- status: PASS_STATIC_SPAN_ERROR_RECEIPT_CONTRACT
- domain_ssot: en_to_ko_translation_subtitle_machine

## Added Rust modules
- crates/ash_core/src/translation_span_error_policy.rs
- crates/ash_core/src/translation_span_error.rs
- crates/ash_core/src/translation_span_packet.rs
- crates/ash_core/src/translation_span_error_receipt.rs
- crates/ash_core/src/translation_span_error_stub.rs
...
## Contract boundary
DECODE-13 localizes QE risks into source/candidate span packets, but it does not execute rewrite, rollback, candidate rejection, model forward, sampling, QE model, COMET/xCOMET, LLM judge, or an external span model.
...
```json
{
  ...
  "patch_id": "16AI-QW-38G-R6A-DECODE-13",
